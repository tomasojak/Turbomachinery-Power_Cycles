# Turbomachinery Assignemnt 1
For now, and probably forever, all code will be in the jupyter notebook. This is the original format and features responsive sliders otherwise not (reasonably) possible to implement.
